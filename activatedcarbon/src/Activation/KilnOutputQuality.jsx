...
// ---- main component ----
export default function KilnOutputQuality() {
  ...
  const fetchQueue = React.useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/api/activation/kiln_output_bag_quality?${qs}`, {
        method: "GET",
        headers,
        credentials: "include",
      });
  ...
  const submitRow = async (payload) => {
    setSaving(true);
    try {
      const res = await fetch(`${API_URL}/api/activation/kiln_output_bag_quality`, {
        method: "POST",
        headers,
        credentials: "include",
