...
export default function KilnFeedQualityFormTab({onSuccess}) {
  ...
  const fields = [
    ...
    },
    {
      ...
      type: 'select',
      required: true,
      optionsFunctionName: 'inwardnumber_kilnfeedquality_select'
    ...
    },
    {
      ...
      type: 'select',
      required: true,
      optionsFunctionName: 'inwardnumber_kilnfeedquality_bag_no_select',
  ...
  const handleSubmit = async (data) => {
    try {
      ...
      const response = await axios.post(
        import.meta.env.VITE_API_URL + '/api/kilnfeedquality',
        payload
      );
