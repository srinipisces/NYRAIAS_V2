...
const AccessPages = {
  'Dashboard': [],
  'Operations': [
    '@Security', '@Lab', 'Material Inward', 'Crusher Performance', 'Material Outward',
    'Kiln Feed','Kiln Feed Quality','Boiler Performance', 'Kiln Output', 'Screening Inward', 'Screening Outward','Stock'
  ],
  'Reports': [],
  'Settings': []
};
